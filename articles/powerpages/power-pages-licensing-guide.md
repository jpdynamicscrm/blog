...
【結論】同一 Contact に紐づくユーザーが暦月中に複数回ログインしても 1 カウントのみです。測定キーは Dataverse Contact レコード ID で、月初リセット後に再度初回ログインした時点で新しい月の 1 として加算されます。
...
簡単な考え方:
- すでに他の製品ライセンスで「その人は高機能アプリを使ってよい」と許されている → Power Pages の容量を消費しない
- 何も持っていない / 社外の人（取引先・お客様など） → Power Pages の容量を消費する
