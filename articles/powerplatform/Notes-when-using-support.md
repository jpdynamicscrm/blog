...
1. [お問い合わせ番号について](#anchor-inquiry-number)
2. [原因究明に関する調査について](#anchor-investigation)
3. [長期的な修正項目として検討される事象について](#anchor-long-term-fix)
4. [一問一答にてお問い合わせを承ります](#anchor-one-question)
5. [カスタマイズに関するご相談について](#anchor-customization)
6. [お客様からご連絡をいただけない場合や、長期間お待ちする場合について](#anchor-no-contact)
7. [参考](#anchor-reference)

<a id='anchor-inquiry-number'></a>
...
<a id='anchor-customization'></a>

## カスタマイズに関するご相談について

当サポート窓口では、お客様のお問い合わせについて、主に標準的なご利用において発生するトラブル発生時や問題解決のための支援をご提供しています。一方で、お客様のご要望に応じたカスタマイズ、システム構築のためのコンサルティング、パフォーマンス チューニングなどのご相談はプロアクティブ サポートの範囲となり、当サポートの対象外です。そのような場合は、弊社のプロアクティブ サービスをご案内させていただくことがございます。

<a id='anchor-no-contact'></a>

## お客様からご連絡をいただけない場合や、長期間お待ちする場合について

次の状況では、お問い合わせについて一旦対応終了のステータスとさせていただくことがございますことをご了承ください。
- 事象の解決につながる可能性が高い情報をご案内した場合や、調査に必要な情報をお伝えいただいたにもかかわらず、複数回お客様からご連絡をいただけない状況
- お客様側での調査ログ採取や確認などに長期間を要することが予測される状況

事象が改善せず引き続き調査が必要である場合や、調査ログが採取された場合は、元のお問い合わせ番号を添えて新規サポート リクエストでお問い合わせください。内容を継続してご対応を再開いたします。
