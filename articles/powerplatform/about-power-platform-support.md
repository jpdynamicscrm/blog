...
テクニカル サポートでは、技術的な問題解決や製品動作についてのご質問に対応しております。ライセンス選定につながるライセンス規約や価格に関するご質問は、契約に関わる内容のため、テクニカル サポートでのご支援の対象外です。
...
上記のようなご質問は、現在のお客様のご契約・ご利用状況を踏まえてご案内させていただく必要があるため、弊社の営業担当または販売パートナー様にご相談ください。
...
弊社の営業担当や確認先が不明な場合は、以下の Power Platform の価格ページ「営業に問い合わせる」よりご相談ください。  
