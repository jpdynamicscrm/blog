...
テクニカル サポートでは、技術的な問題解決や製品動作についてのご質問に対応しております。ライセンス選定のためのライセンス規約や価格に関するご質問は、契約に関わる内容のため、テクニカル サポートでのご支援の対象外です。
具体的には、以下の内容に該当するご質問が対象外となります。
- ライセンスの価格
- ご要望を実現するために必要となるライセンス
- ご利用（予定）のシナリオがライセンス規約違反か否か
- 特定のライセンスでのカバー範囲
- 複数のライセンスの差異 

上記のようなご質問は、現在のお客様のご契約・ご利用状況を踏まえてご案内させていただく必要があるため、弊社の営業担当または販売パートナーにご相談ください。
なお、テクニカル サポートよりライセンスに関わる公開文書やライセンス ガイドの内容を参考情報としてご案内することはございますが、その内容はお客様の状況を踏まえた最終的なライセンス要件を確定するものではございません。テクニカル サポートでの案内内容に基づくライセンスの購入については、責任を負いかねますのであらかじめご了承ください。**ライセンスの購入に関する最終的なご判断にあたっては、必ず弊社の営業担当者または販売パートナー様にご確認ください。**　

弊社の営業担当や確認先が不明な場合は、以下の Power Platform の価格ページ「営業に問い合わせる」より、お電話またはチャットでのご相談もご検討ください。
[Power Platform の価格の概要](https://www.microsoft.com/ja-jp/power-platform/pricing?msockid=2310829d3d1267da136394a43cf8661a)
...
多くのお客様に影響のある事象については Power Platform 管理センターの[既知の事象](https://learn.microsoft.com/ja-jp/power-platform/admin/view-known-issues)に掲載いたしますので、お客様にて状況確認をお願い致します。  
既知の事象に掲載されない事象について定期的な修正状況の確認や修正の進捗報告をご希望の場合は、ご確認が必要なタイミングで、その都度お問い合わせを起票いただくようお願いいたします。   
...
ご要望に合わせた アプリ/ フロー/エージェントの構成検討・作成支援は、アドバイザリ サービスを含むサポート契約をお持ちのお客様も含め、ご支援の範囲外です。サポートリクエストでは、各製品の特定の機能や動作に関してのご質問や、アプリ・フロー・エージェント作成・ご利用時に発生した問題解決についてご支援が可能です。

発生しているエラーへの対処を目的にする場合など、ご案内の過程で一例として弊社にてサンプル フローやサンプル コードを作成し、ご案内することがございますが、あくまでも説明のためのサンプルとしてのご案内となりますので、下記の点についてご承知おきください。

- お客様のご要件を直接満たすためのご提供ではございません。
