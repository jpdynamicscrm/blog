...
サンプル作成やカスタマイズのご依頼をいただいた場合、お客様からご要件の詳細をヒアリングしたうえで、フローやアプリ、エージェントの作成方法についてのご支援をさせていただきますが、成果物としてサンプル アプリやサンプル フロー、サンプル エージェントをご提供することはできかねますので、ご了承ください。  
なお、ご案内の過程で、一例として弊社にてサンプル コードやサンプル アプリ、サンプル フロー、サンプル エージェントを作成し、ご案内することがございますが、あくまでも説明のためのサンプルとしてのご案内となりますので、下記の点についてご承知おきください。
