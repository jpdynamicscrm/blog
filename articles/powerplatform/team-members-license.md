...
- [Dynamics 365 ライセンス ガイド (PDF / 日本語)](https://go.microsoft.com/fwlink/?LinkId=866544&clcid=0x411)
...
- ライセンスの準拠状況は Power Platform 管理センターでダウンロードできる Team Member conformance report で確認できる（参考: [Dynamics 365 Team Members license - Frequently asked questions (Docs)](https://learn.microsoft.com/ja-jp/dynamics365/get-started/team-members-license#frequently-asked-questions)）
