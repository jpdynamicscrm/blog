...
サポート インスタンスへお客様の事象が発生している環境をコピーすることで、Microsoft側で事象の再現確認と調査を一貫して行うことが可能となり、早期解決が見込めます。<br>
...
4. [サポート インスタンスへの環境のコピー](#anchor-about-copy)（当社の作業）
...
> [!NOTE]  
> 上記の同意レベルが表示されない場合は、当社にて同意レベルの変更を代理で実施させていただきます。  
> その場合、作業の同意として以下の項目について記載の上メールにてご依頼いただきますようお願いいたします。  
> 作業完了まで 1、2 営業日ほどお時間いただく場合がございますので予めご了承ください。  
>
> SR No.: *ご起票いただいたお問い合わせの管理番号  
> OrgURL: *事象が発生している環境組織URL  
> Partner: *ご起票者様の会社名  
> EndUser: *エンドユーザー様の会社名  
> Consent: *変更する同意レベル Full or Minimal  
>
> 記載例：  
> SR No.: 2500000000001234  
> OrgURL:https://xxx.crm7.dynamics.com  
> Partner:○○株式会社  
> EndUser:○○株式会社  
> Consent: Full  
...
## 4. サポート インスタンスへの環境のコピー（当社の作業）

作成したサポートインスタンスへのコピーを当社にて実施いたします。  
お客様環境の状態によっては1,2営業日いただく場合がございます。

場合により当社側でコピーが実施できない場合、お客様側でのコピーをご依頼させていただく場合がございます。  
その際はサポートインスタンスの環境名をお伝えさせていただきますので、以下の手順で事象発生中の環境をサポート インスタンスへのコピーをお願いいたします。  
