...
エラーが表示されますが、この初回アクセス時にサポート インスタンス上にユーザーが作成（プロビジョニング）されます。
2. サポートインスタンスにアクセス後、弊社にその旨をご連絡ください。
3. 弊社エンジニアより、プロビジョニングされた作業者アカウントに、システム管理者のセキュリティ ロールを付与いたします。
4. ロールの付与が完了いたしましたら、ご連絡を差し上げますので、コピー作業をお願いいたします。
