...
- Q. ライセンスが必要なフローやアプリの確認方法は？

- A. Power Platform 管理センター 左ペインより、[請求] > [ライセンス] を表示いただき、 [概要] タブのPower Apps・Power Automateをクリックすると、対象のフローがある場合は [要注意] セクションに表示されます。
[](./MC901924/MC901924_ppac.png)
