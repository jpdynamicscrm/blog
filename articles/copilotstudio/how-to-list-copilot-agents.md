...
Copilot Studio にて作成されたエージェントは Dataverse または Dataverse for Teams に保存されます。本記事では Dataverse および Dataverse for Teams ならびに Power Platform 管理センターのレポートからエージェントを一覧を取得する方法をご案内いたします。
