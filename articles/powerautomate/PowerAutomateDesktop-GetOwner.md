---
title: 環境内のデスクトップ フローの所有者、作成日、修正日、修正者を確認する方法
...
今回は、Power Automate for desktop で作成した環境内のデスクトップ フローの所有者、作成日、修正日、修正者等の基礎情報を確認する方法についてご紹介します。

デスクトップ フローに関しても、所有者、作成日、修正日、修正者などの基礎情報を環境単位で簡単に確認できます。
...
環境内のデスクトップ フローの所有者、作成日、修正日、修正者等の基礎情報を確認する方法についてご紹介しました。  
