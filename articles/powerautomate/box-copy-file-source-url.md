...
（直接 Web URL を指定した場合）
<img src="image01a.png" style="max-width:70%;">

（共有リンクのプレビューページを指定した場合）
<img src="image01b.png" style="max-width:70%;">

これらの Web リンクを指定してフローを実行すると、下図のように **フロー自体は成功します**。
<img src="image02.png" style="max-width:70%;">

ところが、**コピー先のファイルを開くと破損した状態になっています**。
<img src="image03.png" style="max-width:70%;">
...
<img src="image04.png" style="max-width:70%;">
...
<img src="image05.png" style="max-width:70%;">
...
<img src="image06.png" style="max-width:70%;">
