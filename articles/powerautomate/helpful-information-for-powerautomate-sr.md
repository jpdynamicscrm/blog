...
1. [情報取得手順詳細](#anchor-how-to-collect)
   ...
   1. [未加工入力、未加工出力](#anchor-raw-input-output)
      * [アクションの未加工入力、未加工出力](#anchor-action-raw-input-output)
      * [トリガーの未加工入力、未加工出力](#anchor-trigger-raw-input-output)
...
<a id='anchor-action-raw-input-output'></a>

### アクションの未加工入力、未加工出力  
実行履歴から該当アクションをクリックして開き、「実行結果」タブ内で以下で表示されるテキストをコピーし、ご提供ください。  
* 「入力」セクション → 「未加工の入力を表示する」 
![](./helpful-information-for-powerautomate-sr/action-raw-input.png)  
* 「出力」セクション → 「未加工の出力を表示する」 
![](./helpful-information-for-powerautomate-sr/action-raw-output.png)  
  
<a id='anchor-trigger-raw-input-output'></a>

### トリガーの未加工入力、未加工出力  
実行履歴から該当トリガーをクリックして開き、「実行結果」タブ内で以下で表示されるテキストをコピーし、ご提供ください。  
* 「入力」セクション → 「未加工の入力を表示する」 
![](./helpful-information-for-powerautomate-sr/trigger-raw-input.png)  
* 「出力」セクション → 「未加工の出力を表示する」 
![](./helpful-information-for-powerautomate-sr/trigger-raw-output.png)  

> [!NOTE]
> 未加工入力、未加工出力いずれも表示されるテキストが多い場合は、「出力がありません」と表示されることがありますが、  
> 「未加工の入力/出力を表示する」をクリックして表示されるテキストをコピーし、ご提供ください。
> ![](./helpful-information-for-powerautomate-sr/action-raw-input-output-note.png)  
